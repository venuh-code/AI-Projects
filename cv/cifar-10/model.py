...
class BasicBlock(nn.Module):
    def __init__(self, in_channels, mid_channels, stride = 1):
        ...
        self.conv1 = nn.Conv2d(in_channels=in_channels, out_channels=mid_channels, kernel_size=3, stride=stride, padding=1, bias=False,)
...
class ResNet(nn.Module):
    ...
    def _make_layers(self, block, mid_channels, num_blocks, stride):
